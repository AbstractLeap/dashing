namespace Dashing.Tools.Tests.ReverseEngineering {
    ...
    public class EngineerTests {
        ...
        public void PrimaryKeySetCorrectly() {
            ...
            var maps = engineer.ReverseEngineer(this.GetSchema(), new SqlServerDialect(), null);
        ...
        public void PeopleSingularized() {
            var engineer = new Engineer(string.Empty);
            var maps = engineer.ReverseEngineer(this.GetPeopleSchema(), new SqlServerDialect(), null);
