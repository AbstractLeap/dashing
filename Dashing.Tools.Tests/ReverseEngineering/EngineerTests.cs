namespace Dashing.Tools.Tests.ReverseEngineering {
    ...
    public class EngineerTests {
        ...
        public void PrimaryKeySetCorrectly() {
            var engineer = new Engineer(string.Empty);
            var maps = engineer.ReverseEngineer(this.GetSchema(), new SqlServerDialect(), null, null);
        ...
        public void PeopleSingularized() {
            var engineer = new Engineer(string.Empty);
            var maps = engineer.ReverseEngineer(this.GetPeopleSchema(), new SqlServerDialect(), null, null);
        ...
        public void OneToOneRelationshipSetCorrectly() {
            var engineer = new Engineer(string.Empty);
            var maps = engineer.ReverseEngineer(this.GetOneToOneSchema(), new SqlServerDialect(), null, null);
        ...
        public void OneToOneSelfReferencingRelationshipSetCorrectly() {
            var engineer = new Engineer(string.Empty);
            var maps = engineer.ReverseEngineer(this.GetSelfReferencingOneToOneSchema(), new SqlServerDialect(), null, null);
        ...
        public void SelfReferencingOneToManyWorks() {
            var engineer = new Engineer(string.Empty);
            var maps = engineer.ReverseEngineer(this.GetSelfReferencingOneToManySchema(), new SqlServerDialect(), null, null);
