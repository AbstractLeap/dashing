namespace Dashing.Cli {
    ...
    using ConnectionStringSettings = Dashing.Cli.Settings.ConnectionStringSettings;
    ...
    internal class Program {
        ...
        private static void ConfigureAssemblyResolution() {
            ...
            AppDomain.CurrentDomain.AssemblyResolve += (sender, iargs) => {
                ...
                var resourceName = "Dashing.Cli.lib." + assemblyName.Name + ".dll";
