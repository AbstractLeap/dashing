namespace Dashing.Tools.Tests.ReverseEngineering {
    ...
    using Dashing.Engine.Dialects;lic void PrimaryKeySetCorrectly() {
        ...
        private Database GetPeopleSchema() {
            ...
            var columns = new List<ColumnDto> { new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "PersonId", DbTypeName = "int", TableName = "People" } };
        ...
        private Database GetSelfReferencingOneToManySchema() {
            ...
            var columns = new List<ColumnDto> {
                                                     new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "CategoryId", DbTypeName = "int", TableName = "Categories" },
        ...
        private Database GetSelfReferencingOneToOneSchema() {
            ...
            var columns = new List<ColumnDto> {
                                                     new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "FooId", DbTypeName = "int", TableName = "Foo" },
        ...
        private Database GetOneToOneSchema() {
            ...
            var columns = new List<ColumnDto> {
                                                     new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "CustomerId", DbTypeName = "int", TableName = "Customers" },
                                                     new ColumnDto { Name = "PersonId",  DbTypeName = "int", TableName = "Customers" },
                                                     new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "PersonId",  DbTypeName = "int", TableName = "People" },
        ...
        private Database MakeSchema() {
            ...
            var columns = new List<ColumnDto> {
                                                     new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "PostId", DbTypeName = "int", TableName = "Posts" },
                                                     new ColumnDto { Name = "BlogId", DbTypeName = "int", TableName = "Posts" },
                                                     new ColumnDto { IsPrimaryKey = true, IsAutoGenerated = true, Name = "BlogId", DbTypeName = "int", TableName = "Blogs" }
                                                 };
            var foreignKeys = new List<ForeignKeyDto> {
