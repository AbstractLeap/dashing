    ...
    public class SqlEngine : IEngine {
        ...
        public virtual int Execute<T>(IDbConnection connection, InsertEntityQuery<T> query) {
            ...
            foreach (var entity in query.Entities) {
                ...
                this.Configuration.CodeManager.Execute(
                    sqlQuery.Sql, 
                    connection, 
                    sqlQuery.Parameters);
        ...
        public virtual int Execute<T>(IDbConnection connection, UpdateEntityQuery<T> query) {
            ...
            if (sqlQuery.Sql.Length > 0) {
                return this.Configuration.CodeManager.Execute(
                    sqlQuery.Sql, 
                    connection, 
                    sqlQuery.Parameters);
            }
        ...
        public T Get<T>(IDbConnection connection, int id, bool? asTracked) {
            ...
            return
                this.Configuration.CodeManager.Query<T>(
                    sqlQuery, 
                    connection, 
                    asTracked.HasValue ? asTracked.Value : this.Configuration.GetIsTrackedByDefault)
                    .SingleOrDefault();
        }
        ...
        public IEnumerable<T> Get<T>(
            ...
            return this.Configuration.CodeManager.Query<T>(
                sqlQuery, 
                connection, 
                asTracked.HasValue ? asTracked.Value : this.Configuration.GetIsTrackedByDefault);
        }
        ...
        public void ExecuteBulkDelete<T>(
            IDbConnection connection, 
            IEnumerable<Expression<Func<T, bool>>> predicates) {
