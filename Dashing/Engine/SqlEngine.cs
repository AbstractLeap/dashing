namespace Dashing.Engine {
    ...
    public class SqlEngine : IEngine {
        ...
        public virtual int Execute<T>(IDbTransaction transaction, InsertEntityQuery<T> query) {
            this.EnsureConfigurationLoaded();
            foreach (var entity in query.Entities) {
                ...
                if (map.PrimaryKey.IsAutoGenerated) {
                    ...
                    var id = this.Configuration.CodeManager.Query<int>(transaction, idQuery).First();
