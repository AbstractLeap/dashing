...
namespace TopHat.Proxy
{
    ...
    {
        private IList<string> suspendedBehaviours;
        ...
        public IProxyManager ProxyManager { get; private set; }
        ...
        public object Intercept(IInvocationInfo info)
        {
            ...
            {
                foreach (var behavour in this.Behaviours)
                {
                    if (!this.suspendedBehaviours.Contains(behavour.Key))
                    {
